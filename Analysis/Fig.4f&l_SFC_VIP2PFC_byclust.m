% compute and plot VIP spike to PFC field coupling sorted by covmat
% clusters
clc; clear; close all;
...
for ianm = ["R","W"]
    ...
    print(fullfile(outfigf,sprintf('VIP2PFC_SFC_by%dclust_%s_log2_rmERP',n,ianm)),'-dpdf','-r0','-bestfit');
    print(fullfile(outfigf,sprintf('VIP2PFC_SFC_by%dclust_%s_log2_rmERP',n,ianm)),'-dpng');
end

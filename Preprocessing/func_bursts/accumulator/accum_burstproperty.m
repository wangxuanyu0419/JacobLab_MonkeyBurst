function mbp = accum_burstproperty(bursts,trialtime,fun_burstprop)
% Computes mean burst property across all bursts at trial times.
%
% Input
% -----
% bursts: cell array
...
n_brst_timpts = histcounts(idx,[1:numel(trialtime) Inf])';
% mean burst property
mbp = NaN(n_metric,numel(trialtime));
for i = 1:n_metric
    mbp(i,:) = p_sum{:,i}./n_brst_timpts;
end

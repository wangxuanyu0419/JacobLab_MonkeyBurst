function [idx, a] = burst_amp(brsts,trialtime)
% Computes expanded burst time indices and burst amplitudes for all specified bursts. This can be used for accumulation by accumarray.
...
% a: double
%   size(idx) vector of burst amplitudes corresponding to bursts in vector idx.
...
% all bursts' time expanded to fwhm and corresponding amplitudes
ta = cell(n_burst,2);
for i_burst = 1:n_burst
    b = brsts{i_burst,{'t','t_sd','amp'}};
    % burst times
